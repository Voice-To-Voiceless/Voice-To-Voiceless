...
export const CALIBRATION_INTERLEAVED_TARGETS = [
  CALIBRATION_TARGETS[4], CALIBRATION_TARGETS[1], CALIBRATION_TARGETS[7],
  CALIBRATION_TARGETS[3], CALIBRATION_TARGETS[5], CALIBRATION_TARGETS[0],
  CALIBRATION_TARGETS[2], CALIBRATION_TARGETS[6], CALIBRATION_TARGETS[8],
] as const;
export const CALIBRATION_TARGET_ORDERS = [CALIBRATION_INTERLEAVED_TARGETS, [...CALIBRATION_INTERLEAVED_TARGETS].reverse()] as const;
